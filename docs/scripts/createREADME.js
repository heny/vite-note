...
function createREADME(dirname, name){
  let curDir = fs.readdirSync(resolve(DOCS_ROOT_DIR, name, dirname))
  ...
  // 写入文件
  fs.writeFileSync(resolve(DOCS_ROOT_DIR, name, dirname, 'index.md'), str)
}

module.exports =  function (name) {
  // 获取文件夹并创建README.md文件
  const webArr = fs.readdirSync(resolve(DOCS_ROOT_DIR, name))
