...
// 配置（需要自己修改）
const gitDefault = {
  clientID: 'Ov23liJi9UTbLulFZGvp', // !需要改成自己的clientID
  clientSecret: '1922d2ebf171dd7e6ef0c687668b694608ed798a', // !需要改成自己的clientSecret
  repo: 'vite-note', // !需要改成自己创建的评论仓库
  owner: 'heny', // !需要改成自己的用户名
  admin: ['heny'], // !需要改成自己的用户名
