import{_ as n,c as s,o as a,d as t}from"./app.6ade61a3.js";const g='{"title":"ts-react","description":"","frontmatter":{},"headers":[{"level":2,"title":"React\u7C7B\u578B\u58F0\u540D","slug":"react\u7C7B\u578B\u58F0\u540D"}],"relativePath":"src/frontend/Typescript/typescript_react.md","lastUpdated":1641282306420}',p={},o=t(`__VP_STATIC_START__<h1 id="ts-react"><a class="header-anchor" href="#ts-react" aria-hidden="true">#</a> ts-react</h1><p>\u5B89\u88C5\uFF1A<code>yarn create react-app demo --template typescript</code></p><p>\u4F20\u503C\u65B9\u5F0F\uFF1A</p><div class="language-tsx"><pre><code><span class="token comment">// Prent.tsx</span>
...
</code></pre></div>__VP_STATIC_END__`,7),e=[o];function c(l,k,u,r,i,d){return a(),s("div",null,e)}var y=n(p,[["render",c]]);export{g as __pageData,y as default};
