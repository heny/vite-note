...
</code></pre></div><h2 id="\u914D\u7F6E\u53C2\u6570"><a class="header-anchor" href="#\u914D\u7F6E\u53C2\u6570" aria-hidden="true">#</a> \u914D\u7F6E\u53C2\u6570</h2><div class="language-nginx"><pre><code>server 		<span class="token comment"># \u914D\u7F6E\u865A\u62DF\u4E3B\u673A\u7684\u76F8\u5173\u53C2\u6570\uFF0C\u53EF\u4EE5\u6709\u591A\u4E2A </span>
...
<span class="token comment"># \u8BBE\u7F6E\u538B\u7F29\u6587\u4EF6\u7684\u7C7B\u578B  \uFF08text/html)</span>
<span class="token directive"><span class="token keyword">gzip_types</span> text/plain application/javascript text/css</span><span class="token punctuation">;</span>
</code></pre></div><p>\u6DFB\u52A0\u5230\u5BF9\u5E94\u7684<code>conf</code>\u6587\u4EF6<code>server</code>\u4E0B\u9762\uFF0C\u6216\u8005\u6DFB\u52A0\u5230\u5168\u5C40\u7684<code>nginx</code>\u914D\u7F6E<code>http</code>\u4E0B\u9762\uFF1B</p><h2 id="\u4EE3\u7406node\u9879\u76EE"><a class="header-anchor" href="#\u4EE3\u7406node\u9879\u76EE" aria-hidden="true">#</a> \u4EE3\u7406node\u9879\u76EE</h2><div class="language-nginx"><pre><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    <span class="token directive"><span class="token keyword">listen</span>	<span class="token number">80</span></span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><p><strong>node \u9879\u76EE\u4E0A\u4F20\u6D41\u7A0B</strong></p><ol><li>\u6253\u5305\u9664node_modules\u6240\u6709\u6587\u4EF6\u4EE5\u53CA\u6587\u4EF6\u5939</li><li>\u4E0A\u4F20\u6253\u5305\u6587\u4EF6</li><li>\u89E3\u538B\u6587\u4EF6</li><li>\u5B89\u88C5\u4F9D\u8D56</li><li>\u542F\u52A8\u9879\u76EE</li></ol><h2 id="\u914D\u7F6Ehttps"><a class="header-anchor" href="#\u914D\u7F6Ehttps" aria-hidden="true">#</a> \u914D\u7F6Ehttps</h2><div class="language-nginx"><pre><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div><h2 id="nginx\u5E38\u7528\u914D\u7F6E"><a class="header-anchor" href="#nginx\u5E38\u7528\u914D\u7F6E" aria-hidden="true">#</a> nginx\u5E38\u7528\u914D\u7F6E</h2><div class="language-nginx"><pre><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    <span class="token directive"><span class="token keyword">listen</span> <span class="token number">80</span></span><span class="token punctuation">;</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div><h2 id="\u5E38\u89C1\u95EE\u9898"><a class="header-anchor" href="#\u5E38\u89C1\u95EE\u9898" aria-hidden="true">#</a> \u5E38\u89C1\u95EE\u9898</h2><h3 id="\u89E3\u51B3socket\u4E2Dnginx\u8F6C\u53D1\u95EE\u9898"><a class="header-anchor" href="#\u89E3\u51B3socket\u4E2Dnginx\u8F6C\u53D1\u95EE\u9898" aria-hidden="true">#</a> \u89E3\u51B3socket\u4E2Dnginx\u8F6C\u53D1\u95EE\u9898</h3><div class="language-nginx"><pre><code><span class="token directive"><span class="token keyword">server</span></span> <span class="token punctuation">{</span>
    <span class="token directive"><span class="token keyword">listen</span>       <span class="token number">80</span></span><span class="token punctuation">;</span>
