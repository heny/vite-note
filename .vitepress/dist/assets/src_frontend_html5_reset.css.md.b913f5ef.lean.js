import{_ as n,c as s,o as a,d as p}from"./app.310fb107.js";const m='{"title":"normalize.css","description":"","frontmatter":{},"headers":[{"level":2,"title":"normalize.css","slug":"normalize-css"}],"relativePath":"src/frontend/html5/reset.css.md","lastUpdated":1615699077000}',t={},o=p(`__VP_STATIC_START__<h2 id="normalize-css"><a class="header-anchor" href="#normalize-css" aria-hidden="true">#</a> normalize.css</h2><p><a href="https://github.com/necolas/normalize.css" target="_blank" rel="noopener noreferrer">https://github.com/necolas/normalize.css</a></p><p>\u6BD4reset\u66F4\u517C\u5BB9\uFF0Creset\u662F\u628A\u9ED8\u8BA4\u6837\u5F0F\u66FF\u6362\u6389\uFF0Cnormalize\u4EC5\u4FEE\u590D\u4E00\u4E9B\u6837\u5F0Fbug\uFF0C\u5E76\u4FDD\u8BC1\u5404\u81EA\u6D4F\u89C8\u5668\u7684\u4E00\u81F4\u6027\uFF1B</p><h1 id="reset-css"><a class="header-anchor" href="#reset-css" aria-hidden="true">#</a> reset.css</h1><p>\u7F51\u5740\uFF1A<a href="https://css-tricks.com/video-screencasts/174-using-local-overrides-in-devtools/" target="_blank" rel="noopener noreferrer">https://css-tricks.com/video-screencasts/174-using-local-overrides-in-devtools/</a></p><div class="language-css"><pre><code><span class="token atrule"><span class="token rule">@media</span> screen <span class="token keyword">and</span> <span class="token punctuation">(</span><span class="token property">prefers-reduced-motion</span><span class="token punctuation">:</span>reduce<span class="token punctuation">)</span></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre></div>__VP_STATIC_END__`,6),e=[o];function c(u,l,i,k,r,d){return a(),s("div",null,e)}var g=n(t,[["render",c]]);export{m as __pageData,g as default};
