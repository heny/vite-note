...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-01.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-02.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-03.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-04.png)

3. 中心内容

p标签可以添加一个.lead，突出文本显示，普通的p标签和带lead的标签：

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-05.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-06.png)

8. 引用样式

（1）使用`<blockquote>`标签，会多一个竖线；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-07.png)

（2）引用来源，在blockquote标签内，添加footer标明引用来源，来源名包进cite标签；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-08.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-09.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-10.png)

（2）用户输入，使用`<kbd>`标签

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-11.png)

（3）代码块：`<pre>`标签；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-12.png)

（4）程序输出

使用samp标签，和普通p标签的对比：

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-13.png)


## 五、表格
1. 给表格添加类：.table；基本样式：

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-14.png)
2. 条纹状表格：.table-striped类；会给tbody添加条纹；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-15.png)
3. 带边框的表格：.table-bordered；每个单元格都增加边框；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-16.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-17.png)
总结：
1. .table 加上边框
2. .table-striped 加条纹
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-18.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-19.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-20.png)

（2）控制大小，给input-group再添加相应的类名，input-group-lg/sm；输入框会自动变大；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-21.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-22.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-23.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-24.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-25.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-26.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-27.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-28.png)
...
```
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-29.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-30.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-31.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-32.png)

3. 尺寸

可用的类：.btn-lg、.btn-sm、.btn-xs可以获得不同的尺寸；

![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-33.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-34.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-35.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-36.png)
...
![image](https://notecdn.heny.vip/images/bootstrap_全局css样式-37.png)
